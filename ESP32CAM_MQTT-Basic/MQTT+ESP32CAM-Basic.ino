 ...
 * por: Hugo Escalpelo
 * Modificado: Angel Eduardo Ibañez Rodriguez. 
...
//Datos de WiFi
const char* ssid = "Yeahs";  // Aquí debes poner el nombre de tu red
const char* password = "Ma72An99Da02";  // Aquí debes poner la contraseña de tu red
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    client.publish("esp32/data/grupo2", dataString); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  Serial.print(topic);
  Serial.print(": "); // agregado para una mejor estética
  ...
  // El ESP323CAM está suscrito al tema esp/data/grupo2
  if (String(topic) == "esp32/data/grupo2") {  // En caso de recibirse mensaje en el tema esp32/output
    if(messageTemp == "true"){
